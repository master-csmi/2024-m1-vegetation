...
(latitude, longitude) will be converted to Cartesian coordinates (x, y, z) using
a Mercator projection. To achieve this we will assume the Earth is a geodesic
define as WGS84 \cite{wgs84} and use the WGS84toCartesian\cite{wgs84_to_cartesian} open source header-only
