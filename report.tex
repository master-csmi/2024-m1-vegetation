...
The stl format\cite{stl_format} is a widely used format for 3D printing and computer-aided design (CAD)
...
The ASCII versions is defined as :
\begin{lstlisting}
solid name
...
endsolid name
\end{lstlisting}
But for efficiency we will use the stl format in its \textbf{binary mode}.
