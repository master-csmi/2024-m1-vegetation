...
We created a GitHub repository to manage the project and facilitate collaboration.
...
\subsection{Roadmap}
As of \texttt{V0} (March 2024) our roadmap includes the following milestones and issues:  
\begin{figure}[H]
    \centering
