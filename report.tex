...
\begin{ganttchart}[
    ...
    inline]{1}{20}
    % Labels
    \gantttitle{V0 Roadmap}{20} \\

    % Setting group if any
    \\
    \ganttgroup[group/.append style={fill=red}]{GitHub Project Setup}{1}{7} \\ 
    \\
    \ganttgroup[group/.append style={fill=green}]{Roadmap}{3}{9} \\ 
    \\
    \ganttgroup[group/.append style={fill=blue}]{Initial Bibliography}{5}{11} \\ 
    \\
    \ganttgroup[group/.append style={fill=yellow}]{V0 Report}{7}{13} \\ 
    \\
    \ganttgroup[group/.append style={fill=purple}]{V0 Presentation}{9}{15} \\
\end{ganttchart}
...
\begin{ganttchart}[
    ...
    inline]{1}{20}
    % Labels
    \gantttitle{V1 Roadmap}{20} \\

    % Setting group if any
    \\
    \ganttgroup[group/.append style={fill=red}]{Tree model}{1}{7} \\ 
    \\
    \ganttgroup[group/.append style={fill=green}]{Tree database}{3}{9} \\ 
    \\
    \ganttgroup[group/.append style={fill=blue}]{CGAL}{5}{11} \\
    \\
    \ganttgroup[group/.append style={fill=yellow}]{CI workflow}{7}{13} \\
    \\
    \ganttgroup[group/.append style={fill=purple}]{V1 Report}{9}{15} \\
\end{ganttchart}
...
\begin{ganttchart}[
    ...
    inline]{1}{20}
    % Labels
    \gantttitle{V2 Roadmap}{20} \\

    % Setting group if any
    \\
    \ganttgroup[group/.append style={fill=red}]{Code review}{1}{7} \\ 
    \\
    \ganttgroup[group/.append style={fill=green}]{Gather feedback}{3}{9} \\ 
    \\
    \ganttgroup[group/.append style={fill=blue}]{Performance analysis}{5}{11} \\ 
    \\
    \ganttgroup[group/.append style={fill=yellow}]{Finalize report}{7}{13} \\ 
    \\
    \ganttgroup[group/.append style={fill=purple}]{Finalize presentation}{9}{15} \\
\end{ganttchart}
