...
Where :
\begin{itemize}
    \item \texttt{A(lat, lon)} represent the bottom right corner of the bounding box representing the area to retrieve data from.
    \item \texttt{B(lat, lon)} represent its top right corner.
