...
\begin{frame}{Impact of vegetation on urban heat}
  \begin{figure}[h] % 'h' option tries to place the figure here
    ...
    \caption{thermal signature of a street } % Caption for referencing
...
\begin{frame}{Aerial thermography}
  \begin{figure}[h] % 'h' option tries to place the figure here
    ...
    \caption{aerial thermography of a city } % Caption for referencing
...
\begin{frame}{3D city model}
  \begin{figure}[h] % 'h' option tries to place the figure here
    ...
    \caption{3D city model of New York } % Caption for referencing
