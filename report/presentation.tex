...
\begin{frame}{Objectives}
  ...
  \begin{itemize}
      ...
      \item \textbf{\textcolor{red}{Integrating}} \textbf{tree models} into \textbf{terrain meshes}
      \item \textbf{\textcolor{red}{Optimizing}} \textbf{computational efficiency}
      \item \textbf{\textcolor{red}{Delivering}} versions \textbf{V0}, \textbf{V1}, and \textbf{V2} by specified deadlines
  \end{itemize}
\end{frame}
...
\begin{frame}{Mercator's projection}
  \begin{figure}[H]
    ...
    \caption{Mercator's projection}
\end{figure}
Mathematically, with a point A, \\
A(latitude, longitude) = A($\phi$, $\lambda$),\\
 then its projection on the Mercator map will have coordinates 
\begin{equation}
  \left\{
  \begin{array}{l}
      x =  \lambda - \lambda_{0} \\
...
We can use the \textit{WGS84toCartesian.hpp} open source header-only
