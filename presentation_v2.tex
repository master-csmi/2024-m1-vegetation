...
\begin{frame}{Alpha Wrapping}
  \begin{figure}[H]
    ...
    \captionsetup{font={scriptsize}}
    \caption{Alpha Wrapping in 2D with different Alpha parameters.}
\end{figure}
\end{frame}
...
\begin{frame}{Alpha Wrapping Japan}
  \begin{center}
    \movie[width=1\textwidth,height=0.8\textheight,poster,showcontrols]{}{videos/japan.mp4}
\end{center}
\end{frame}
